...
namespace Game.Player.Data
{
    ...
    public class VehicleSettingsSO : ScriptableObject
    {
        ...
        [Header("Wheels")] [SerializeField] [Range(0.0f, 0.5f)]
        private float _wheelsPaddingX;

        [SerializeField] [Range(0.0f, 0.5f)] private float _wheelsPaddingZ;

        [Header("Body")] [SerializeField] private float _chassiMass;
        ...
        [Header("Power")] [SerializeField] private float _acceleratePower;
        [SerializeField] private float _brakesPower;
        [SerializeField] private float _maxSpeed;
        [SerializeField] private float _maxReverseSpeed;

        [Header("Handling")] [SerializeField] [Range(0.0f, 60.0f)]
        private float _steerAngle = 45.0f;
        ...
        [Header("Other")] [SerializeField] private float _airResistance;
