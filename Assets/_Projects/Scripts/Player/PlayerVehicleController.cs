...
namespace _Projects.Player
{
    public class PlayerVehicleController : NetworkBehaviour
    {
        ...
        private static readonly WheelType[] _frontWheels = new WheelType[]
        ...
        private void UpdateAccelerate()
        {
            ...
            foreach (WheelType wheel in _wheels)
            {
                ...
                _vehicleRigidbody.AddForceAtPosition(_accelerateInput * _vehicleSettings.AcceleratePower * wheelForward,
                    position);
            }
        }
        ...
        {
            _vehicleRigidbody.AddForce(_vehicleCollider.size.magnitude * _vehicleSettings.AirResistance *
